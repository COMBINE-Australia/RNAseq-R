...
plot(myCPM[,1], countdata[,1], main="Relationship between CPM and raw counts", xlab="counts-per-million", ylab="raw counts", cex.lab=1.2)
# Let us limit the x and y-axis so we can actually look to see what is happening at the smaller counts
plot(myCPM[,1], countdata[,1], ylim=c(0,50), xlim=c(0,3), main="Relationship between CPM and raw counts", xlab="counts-per-million", ylab="raw counts", cex.lab=1.2)
...
**Solution**
```{r cpms-vs-counts-solution, echo=FALSE}
plot(myCPM[,2], countdata[,2], ylim=c(0,50),xlim=c(0,3), main="Relationship between CPM and raw counts", xlab="counts-per-million", ylab="raw counts", cex.lab=1.2)
abline(v=0.5,col=4)
abline(h=10,col=4)
```
